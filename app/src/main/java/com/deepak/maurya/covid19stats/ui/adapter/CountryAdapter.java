package com.deepak.maurya.covid19stats.ui.adapter;
...
import com.deepak.maurya.covid19stats.api.CoronaApi;
import com.deepak.maurya.covid19stats.api.CoronaService;
import com.deepak.maurya.covid19stats.data.CountriesResponse;
import com.deepak.maurya.covid19stats.ui.activity.DetailActivity;
...
public class CountryAdapter extends RecyclerView.Adapter<CountryAdapter.CountryHolder> implements Filterable {
    ...
    public void onBindViewHolder(CountryHolder holder, final int position) {
        ...
        holder.cc.setText("Total Cases : "+ countriesListed.get(position).getCases());
    ...
    public class CountryHolder extends RecyclerView.ViewHolder {
        ...
        public CountryHolder(View v) {
            ...
            cc=v.findViewById(R.id.tvCountryTotalCases);
